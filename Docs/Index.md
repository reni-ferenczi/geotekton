...
- [Editing](Editing.md) — The tools and their keys, the feature tree rows, highlighting children, turning features, editing vertices, splitting and dividing between parts, measuring, circles and axis circles, hotspots, topologies, closed and midway topologies, the ridge and the crust of bands, isochrons and flowlines a split leaves, with the bands colored by the age of the crust in them, kept off the tree and drawn under everything, what a second split of a half does to them, the triple junction a cut across older sea floor makes, the children it cuts along, the light, the view settings, navigating the planet and the view toolbar
