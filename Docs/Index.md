...
- [Editing](Editing.md) — The tools, the feature tree rows, editing vertices, splitting, measuring, small circles, line topologies, navigating the planet and the view toolbar
...
- [Shader](Shader.md) — Planet shader, map projections, feature geometry and the outline overlay
