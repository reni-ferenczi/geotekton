...
- [Editing](Editing.md) — The tools and their keys, the feature tree rows, highlighting children, turning features, editing vertices, splitting, measuring, circles and axis circles, hotspots, topologies and closed topologies, the crust a split leaves, the light, the view settings, navigating the planet and the view toolbar
