...
- **Segments of a circle** — Shown only while the Circle tool is active; see
  [The Circle tool](#segments-of-a-circle).
...
**Segments of a circle** box in the toolbar says how many: from 3 to 720,
